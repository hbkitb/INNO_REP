report 50108 "Toldpos_Inno_New"
{
        ...
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                dataitem(PageLoop; Integer)
                {
                    ...
                    //HBK / ITB - 190221 - toldposition ->
                    column(Toldpos01; toldpos[1])
                    {
                    }
                    column(ToldBel01; toldbel[1])
                    {
                    }
                    column(ToldTxt01; toldtxt[1])
                    {
                    }
                    column(ToldAnt01; Toldant[1])
                    {
                    }
                    column(Toldpos02; toldpos[2])
                    {
                    }
                    column(ToldBel02; toldbel[2])
                    {
                    }
                    column(ToldTxt02; toldtxt[2])
                    {
                    }
                    column(ToldAnt02; Toldant[2])
                    {
                    }
                    column(Toldpos03; toldpos[3])
                    {
                    }
                    column(ToldBel03; toldbel[3])
                    {
                    }
                    column(ToldTxt03; toldtxt[3])
                    {
                    }
                    column(ToldAnt03; Toldant[3])
                    {
                    }
                    column(Toldpos04; toldpos[4])
                    {
                    }
                    column(ToldBel04; toldbel[4])
                    {
                    }
                    column(ToldTxt04; toldtxt[4])
                    {
                    }
                    column(ToldAnt04; Toldant[4])
                    {
                    }
                    column(Toldpos05; toldpos[5])
                    {
                    }
                    column(ToldBel05; toldbel[5])
                    {
                    }
                    column(ToldTxt05; toldtxt[5])
                    {
                    }
                    column(ToldAnt05; Toldant[5])
                    {
                    }
                    column(Toldpos06; toldpos[6])
                    {
                    }
                    column(ToldBel06; toldbel[6])
                    {
                    }
                    column(ToldTxt06; toldtxt[6])
                    {
                    }
                    column(ToldAnt06; Toldant[6])
                    {
                    }
                    column(ToldKg; toldkg)
                    {
                    }
                    column(AntKolli; Antkolli)
                    {
                    }
                    //HBK / ITB - 190221 - toldposition -> 
                    dataitem("Sales Invoice Line"; "Sales Invoice Line")
                    {
                        ...
                        trigger OnAfterGetRecord();
                        //HBK / ITB - Beregn toldpositioner mv - 180221 ->
                        var
                            ItemGroupTold: Record "Inventory Posting Group";
                            ItemTold: Record Item;
                            Tx: Integer;
                        //HBK / ITB - Beregn toldpositioner mv - 180221 <-                       
                        ...
                        begin
                            ...
                            if Type = Type::Item then begin
                                //Message('item');//
                                if ItemTold.Get("Sales Invoice Line"."No.") then begin
                                    //Message('itemtold');//
                                    if ItemGroupTold.Get(ItemTold."Inventory Posting Group") then begin
                                        ...
                                        if Tx <= 0 then begin
                                            Tx := 3;
                                            ItemGroupTold.Get('03');  //
                                        end;
                                        if Tx >= 7 then begin
                                            Tx := 3;
                                            ItemGroupTold.Get('03');
                                        end;
                                        ToldPos[Tx] := ItemGroupTold.ToldPos;
                                        ToldTxt[Tx] := ItemGroupTold.Description;
                                        ToldAnt[Tx] := ToldAnt[Tx] + Quantity;
                                        ToldBel[Tx] := ToldBel[Tx] + "Line Amount";
                                        ToldKg := ToldKg + (ItemTold."Net Weight" * Quantity);
                                    end;
                                end;
                                //ToldKg := 123456;//
                                //Message(Format(Tx));
                                //Message(ItemGroupTold.Code);
                            end;
                            // HBK / ITB - Beregn toldpositioner mv - 180221 <-
        ...
        layout
        {
            area(content)
            {
                group(Indstillinger)
                {
                    ...
                    //HBK / ITB - 190221 - Antal Kolli - told ->
                    field(AntKolli; AntKolli)
                    {
    ...
    var
        ...
        //HBK / ITB - 180221 Toldpositioner -> 
        ToldPos: array[6] of Text[10];
        ToldTxt: array[6] of Text[20];
        ToldAnt: array[6] of Decimal;
        ToldBel: array[6] of Decimal;
        Toldpos01: Text[10];
        Toldpos02: Text[10];
        Toldpos03: Text[10];
        Toldpos04: Text[10];
